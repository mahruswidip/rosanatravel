<?php
class Koor_wakro extends CI_Controller
{
  ...
  {
    $data['_view'] = 'absensikaryawan/koordinator/wakro/index';
    ...
    public function add()
    {
        ...
        $data['_view'] = 'absensikaryawan/koordinator/wakro/add';
        $this->load->view('layouts/main', $data);
    }
    public function edit($id_karyawan) 
    {
        ...
        $data['_view'] = 'absensikaryawan/koordinator/wakro/edit';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function logabsen()
    {
        ...
        $data['_view'] = 'absensikaryawan/koordinator/wakro/logabsen';
        $this->load->view('layouts/main', $data);
    }
    ...
    public function download_absen()
    {
        ...
        $sheet->setCellValue('B1', "$tanggal_awal ~ $tanggal_akhir (wakro GROUP)");
    ...
    public function logizin()
    {
        ...
        $data['_view'] = 'absensikaryawan/koordinator/wakro/logizin';
        $this->load->view('layouts/main', $data);
    }
