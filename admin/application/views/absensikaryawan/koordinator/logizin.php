                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <?php if ($row['status_pengajuan'] == 'Diajukan'): ?>
                                            <a href="<?php echo site_url('absen_koor/update_status?id='.$row['id_pengajuan'].'&status=Disetujui'); ?>" class="btn bg-gradient-success btn-sm">
                                                <span class="fa fa-check"></span> Setujui
                                            </a>
                                            <a href="<?php echo site_url('absen_koor/update_status?id='.$row['id_pengajuan'].'&status=Ditolak'); ?>" class="btn bg-gradient-danger btn-sm">
