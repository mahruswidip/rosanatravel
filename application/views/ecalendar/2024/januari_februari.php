<img src="<?php echo base_url('assets/images/ecalendar/2024/') ?>kalenderrosana1.jpg" alt="Image" class="img-fluid mb-4" style="border-bottom-left-radius: 2rem;border-bottom-right-radius: 2rem; box-shadow: 2px 2px 4px #575757;">
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <div class="custom-block">
                    <ul class="list-unstyled social-icons light">
                        ...
                        <li><a href="<?php echo base_url() ?>ecalendar"><span class="icon-backward"></span></a></li>
                    </ul>
            ...
            <div class="col text-center">
                <div class="custom-block">
                    <ul class="list-unstyled social-icons light">
                        <li><a href="<?php echo base_url() ?>ecalendar/maret_april"><span class="icon-forward"></span></a></li>
                    </ul>
