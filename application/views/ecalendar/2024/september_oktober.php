<img src="<?php echo base_url('assets/images/ecalendar/2024/') ?>kalenderrosana5.jpg" alt="Image" class="img-fluid mb-4" style="border-bottom-left-radius: 2rem;border-bottom-right-radius: 2rem; box-shadow: 2px 2px 4px #575757;">
<div class="site-footer" style="background-color: #1A374D; padding-top: 0px!important;;">
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <div class="custom-block">
                    <ul class="list-unstyled social-icons light">
                        <!-- Use a custom class to apply the mirror effect -->
                        <li><a href="<?php echo base_url() ?>ecalendar/juli_agustus"><span class="icon-backward"></span></a></li>
                    </ul>
                    <p style="color: white; font-size: smaller;">Bulan Sebelum</p>
                </div>
            </div>
            <div class="col text-center">
            ...
            <div class="col text-center">
                <div class="custom-block">
                    <ul class="list-unstyled social-icons light">
                        <li><a href="<?php echo base_url() ?>ecalendar/november_desember"><span class="icon-forward"></span></a></li>
                    </ul>
                    <p style="color: white; font-size: smaller;">Bulan Setelah</p>
                </div>
            </div>
        </div>
    </div>
