                ...
                <div class="owl-single owl-carousel no-nav">
                    <div class="testimonial mx-auto">
                        <figure class="img-wrap">
                            <img src="<?php echo base_url('assets/') ?>images/testimoni/burosana.png" alt="Image"
                                class="img-fluid">
                        </figure>
                        <h3 class="name">Ibu Hj. Rosana Hayati</h3>
                        <blockquote>
                            <p>&ldquo;Kami Harus membawa sesuatu yang berbeda. Inovasi dan perbaikan pelayanan
                                menunjukkan bahwa kami dinamis dan memahami keinginan pelanggan.&rdquo;</p>
                        </blockquote>
                    </div>

                    <div class="testimonial mx-auto">
                        <figure class="img-wrap">
                            <img src="<?php echo base_url('assets/') ?>images/testimoni/pakgunawan.jpg" alt="Image"
                                class="img-fluid">
                        </figure>
                        <h3 class="name">Bpk. H. Gunawan Aprilianto</h3>
                        <blockquote>
                            <p>&ldquo;Kami sangat puas dengan pelayanan Rosana Travel dalam membimbing ibadah Umroh dan
                                Haji kami bersama seluruh rombongan Pandawa 87 Group.&rdquo;</p>
                        </blockquote>
                    </div>

                    <div class="testimonial mx-auto">
                        <figure class="img-wrap">
                            <img src="<?php echo base_url('assets/') ?>images/testimoni/pakbu.png" alt="Image"
                                class="img-fluid">
                        </figure>
                        <h3 class="name">Bpk. H. Fakhruddin & Ibu Hj. Silvi</h3>
                        <blockquote>
                            <p>&ldquo;Alhamdulillah kita merasa nyaman, petugasnya sangat ramah dan juga
                                bersahabat.&rdquo;</p>
                        </blockquote>
                    </div>
                    ...
                    <div class="testimonial mx-auto">
                        <figure class="img-wrap">
                            <img src="<?php echo base_url('assets/') ?>images/testimoni/paksaudara.png" alt="Image"
                                class="img-fluid">
                        </figure>
                        <h3 class="name">Bpk. H. Soeyono</h3>
                        <blockquote>
                            <p>&ldquo;Rasa kekeluargaan yang baik terhadap crew (kepada jamaah) itu betul-betul kayak
                                saudara. Betul-betul kayak saudara dan itu yang saya rasakan.&rdquo;</p>
                        </blockquote>
                    </div>
